...
// imports para prueba de consultorios
  ...
  guardarInfo() {
    ...
    if (this.consultorio >= 1) {
      ...
      for( let i = 0; i < this.consultorio+1; i++ ) {
        ...
        consultorios.push({ nombre: nombre, medico: medico });
      }
      ...
      console.log((<HTMLInputElement>document.getElementById('input-nombre-1')).value, (<HTMLInputElement>document.getElementById('input-medico-1')).value);
    }
  }
