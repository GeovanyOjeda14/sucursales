...
export class CrearSucursalComponent implements OnInit {
  ...
  departamentoSelect(){ 
    ...
    this._aplicationService.getMunicipio(this.departSelect.value).subscribe( (response) => {
  ...
  medicoTrue(){
    ...
    for(let i = 0; i < this.medicos.length; i++) {
      // console.log(this.medicos[i].nombre);
      if(this.medico_id === this.medicos[i].id ){
        // console.log(this.medicos[i].nombre )
  ...
  posisionAEliminar(i, id_medico) {
    this.posicionEliminar = i;
    this.medico_id = id_medico;
    // console.log(this.infoConsultorios);
  }
 ...
 // pestana(pestana) {
  ...
  //       let l = document.getElementById('consultorios');
  //       l.className = 'list-group-item';
  //       li.className = 'list-group-item active';
  //   }

  //   if (li.id === 'consultorios') {
  ...
  // if(this.infoConsultorios.length < 1) {

    //   if(!this.medicoSelect.valid || !this.nombreConsultorio.valid || !this.servicioSelect.value ) {
    //     console.log('completar datos horario 1');
    //   } else {
    //     this.infoConsultorios.push({medico_id: this.medicoSelect.value, nombreConsultorio: this.nombreConsultorio.value,
    ...
    //   this.infoConsultorios.push(this.infoConsultorio);
