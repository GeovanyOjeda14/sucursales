...
import { ImagenesPdfService } from '../../services/imagenes-pdf.service';
...
@Component({
  ...
  providers: [ImagenesPdfService, MedicoService]
})
export class HistoriaOptometriaComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
              private _imagenesService: ImagenesPdfService,
  ...
  pdfMedicamentos() {
    var doc = new jsPDF();
    let imagen = this._imagenesService.getImagenMedicamentosRemision();
  ...
  pdfCertificado() {
    // console.log('aqui');
    var doc = new jsPDF();
    let imagen = this._imagenesService.getImagenCertificado();
